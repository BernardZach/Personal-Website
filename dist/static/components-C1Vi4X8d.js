(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function o(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(t){if(t.ep)return;t.ep=!0;const i=o(t);fetch(t.href,i)}})();function u(){const n=window.location.pathname,e=window.location.hash;return n.includes("index.html")||n==="/"?e==="#about"?"About Me":e==="#experience"?"Experience":e==="#resume"?"Resume":"Home":n.includes("blog.html")?"Blog Posts":""}function c(){const n=u();document.querySelectorAll(".fixed-menu .item").forEach(e=>{e.classList.toggle("active",e.textContent.trim()===n)}),document.querySelectorAll(".secondary-menu .item").forEach(e=>{e.classList.toggle("active",e.textContent.trim()===n)})}function m(){return`
    ...
    <div class="ui inverted vertical footer segment">
        ...
        `}o+="</div>",n.innerHTML=o,$(".ui.accordion").accordion()}document.addEventListener("DOMContentLoaded",g);window.addEventListener("hashchange",()=>{c()});document.addEventListener("DOMContentLoaded",v);document.addEventListener("DOMContentLoaded",()=>{const n=document.querySelector(".hamburger"),e=document.querySelector(".mobile-menu");function o(){e.innerHTML=`
            <a href="/index.html" class="item">Home</a>
            <a href="/index.html#about" class="item">About Me</a>
            <a href="/index.html#experience" class="item">Experience</a>
            <a href="/index.html#resume" class="item">Resume</a>
